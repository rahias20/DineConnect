...
import 'package:dine_connect/view/register_page.dart';
...
void main() {
  group('RegisterPage Tests', () {
    ...
    testWidgets('RegisterPage widgets are present',
    ...
    testWidgets('Displays error messages for invalid input',
      ...
      await tester.enterText(
          find.byType(MyTextFormField).at(0), 'not_valid_email');
      ...
      await tester.enterText(
          find.byKey(const Key('confirmPasswordField')), 'notmatching');
      ...
      expect(
          find.text('Password must be at least 8 characters long'), findsAny);
